...
const Home = () => {
    ...
    const [text] = useTypewriter({
        words: ["Luca", "Appassionato di Informatica", "Full Stack Developer"],
        deleteSpeed: 30,
        loop: 0
    })
            ...
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
                ...
                <div className='flex flex-col justify-center h-full w-full md:w-2/3' >
                    <h2 className='text-4xl sm:text-5xl font-bold text-white'>
                        Ciao, sono <span className='text-blue-500'>{text}</span> <Cursor />
                    </h2>
                    <p className='text-gray-500 py-4 max-w-md'>
                        Benvenuto nel mio sito! ...mi piace sfidarmi e superare i miei limiti.
                    </p>
                    <div>
